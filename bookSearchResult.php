<<!-- This page loads the matching books from the database using parameters sent from the search page, displays buttons to contact donors, and implements pagination for the results -->
 ...
 <?php include "CSS/bookSearchResult.css" ?>
    ...
    <body>
        <?php
        //Load the wordpress file with connection info
