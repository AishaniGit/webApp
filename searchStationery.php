...
This plugin searches for available stationery from the database. 
*/
/* Locate the wp-load.php file and load it */
...
function stationeryInputInformation()
{
   ...
   ?>
    ...
    <!--Form to enter stationery search criteria-->
    <style>
 ...
 <?php include "CSS/searchBooks.css" ?>
    ...
    <center>
        <div class="container">
            <form action="https://asecondlife.online/wp-content/plugins/custom/stationerySearchResult.php" method="get">
                <div>
                    <!-- <fieldset> -->
